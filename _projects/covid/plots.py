...
def weib31(x, k, a, b, g, k2, a2, b2, k3, a3, b3):
	return weib(x, k, a, b, g) + weib(x, k2, a2, b2, g) + weib(x, k3, a3, b3, g)

def weib4(x, k, a, b, g, k2, a2, b2, g2, k3, a3, b3, g3):
	return weib(x, k, a, b, g) + weib(x, k2, a2, b2, g2) + weib(x, k3, a3, b3, g3)
...
num_peaks = dict(zip(interactive, [1, 4, 3, 2, 1, 2, 2, 2]))
for country in interactive:
	try:
		...
		func = [(weib, [60000, 14, 4, 500], [2000, 54, 4, 500]), 
				...
				(weib3, [100000, 14, 4, 500, 100000, 14, 100000, 14], [2000, 54, 4, 500, 2000, 54, 2000, 54]),
				(weib31, [100000, 14, 4, 500, 100000, 14, 4, 100000, 14, 4], [2000, 54, 4, 500, 2000, 54, 4, 2000, 54, 4]),
				(weib4, [100000, 14, 4, 500, 100000, 14, 4, 600, 100000, 14, 4, 700], [2000, 54, 4, 500, 2000, 54, 4, 600, 2000, 54, 4, 700])]
